...
initExp['args']['features'] = [[1, 2, 3]]*25
# How many tries does each user see?
names = os.listdir('strangefruit30')
initExp['args']['mapping'] = [name for name in names
                              if '.DS' not in name]
...
initExp['app_id'] = 'DuelingFeatures'
